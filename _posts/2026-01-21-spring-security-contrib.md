...
### 기여를 망설이는 당신에게
오픈소스에 기여한다는게 막연하게 느껴질 수 있다고 생각한다. 관심은 있지만 무엇부터 해야 할지 몰라 망설여진다면, 기여 모임에 참여해보는 것을 추천한다.

오픈소스 생태계에 익숙한 분들에게 조언을 구할 수 있고 기여하는 과정을 곁에서 지켜보는 것만으로도 진입 장벽은 훨씬 낮아진다. 나 또한 모임에서 진행된 오프라인 세션을 통해 방향을 잡는 데 도움을 받을 수 있었다.

내가 참여했던 오픈소스 기여 모임에 대한 링크를 남긴다.
{% linkpreview "https://medium.com/opensource-contributors" %}